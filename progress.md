...
| Phase                                      | Status      | Notes                                                                                                                                                                                               |
| ------------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Layout and prompt foundation            | in progress | Cursor-aware editing and multiline entry are in place. Wrapped-line navigation is being added from upstream cursor behavior in `sourcecode/utils/Cursor.ts` and `sourcecode/hooks/useTextInput.ts`. |
...
- Remaining in Phase 1: clipboard image paste support and fuller prompt footer behavior.
