...
- Planned: continue Phase 6 visual polish by removing low-value status copy such as `Engine ready (protocol v1)` and replacing it with user-relevant readiness or activity signals that actually help orient the session.
