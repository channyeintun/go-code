...
| Phase 4 memory                      | in progress | L     | Project and user MEMORY.md index loading, staleness cues, write-path scaffolding, model-backed side-query recall, structured MEMORY.md entry parsing, on-demand note loading, and separate memory-recall cost surfacing are wired in. |
