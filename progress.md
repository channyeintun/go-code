...
| Phase 4 memory                      | in progress | L     | Project and user MEMORY.md index loading, staleness cues, write-path scaffolding, model-backed side-query recall, and structured MEMORY.md entry parsing with on-demand note loading are wired into prompt assembly.      |
